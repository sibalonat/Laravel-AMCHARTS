                        ...
                        <div class="col-12 my-5">
                            <div class="row w-100">
                                <div class="col-sm-6">
                                    ...
                                    <textarea name="en_description" cols="30" rows="10" class="form-control" id="post_content_en"></textarea>
                                </div>
                                <div class="col-sm-6">
                                    <label for="post_content_al" class="badge badge-secondary p-1 w-100"> Albanian </label>
                                    <textarea name="al_description" cols="30" rows="10" class="form-control" id="post_content_al"></textarea>
                                </div>
                            </div>
                        </div>
                        <div class="col-4">
